...
class BanheiroFragment : BaseFragment() {
    ...
    override val layoutResId: Int
        get() = R.layout.fragment_banheiro
    ...
    override fun setUpView(view: View) {
        ...
        ledSwitch.setOnCheckedChangeListener { _, isChecked ->
            if (isChecked) {
                ...
                val publish = Publish("64c2c909ce81b/esp32/casa/banheiro/ledbanheiro", "1", 0, false)
                ...
                val publish = Publish("64c2c909ce81b/esp32/casa/banheiro/ledbanheiro", "0", 0, false)
                val mainActivity = activity as? MainActivity
                mainActivity?.onMqttPublish(publish, null)
                ledMode = false
                ledStatus = "OFF"
    ...
    fun updateHumBanheiro(message: String?) {
